...
- (NSArray *)dataArray:(NSDictionary *)dictionary
{
    ...
    if (costedCrowdfundingCoin > 0) {
        str = [str stringByAppendingFormat:@"  %d抽奖币", costedCrowdfundingCoin];
    }
    ...
    if (unusedThriceCoint > 0) {
        ...
        title = [NSString stringWithFormat:@"返回抽奖币 %@", reason];
        detail = [NSString stringWithFormat:@"%d抽奖币", unusedThriceCoint];
