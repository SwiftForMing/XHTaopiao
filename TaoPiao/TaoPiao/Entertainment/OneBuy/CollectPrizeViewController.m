...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 1) {
        if (indexPath.row == 0) {
            ...
            } else if ([stauts isEqualToString:@"已兑换抽奖币"]) {
...
- (UITableViewCell *)cellForCollectPrize:(NSInteger)index
{
    ...
    switch (index) {
        ...
        case 2:
        {
            ...
            subview.firstRowLabel.text = [NSString stringWithFormat:@"我要兑换%@个抽奖币", _orderInfo.goodvalues];
...
- (UITableViewCell *)cellForCollectPrizeToCoin:(NSInteger)index
{
    ...
    switch (index) {
        ...
        case 3:
        {
            ...
            NSString *str = [NSString stringWithFormat:@"你已兑换%@个抽奖币。", _orderInfo.goodvalues];
            UIView *subview = [self subviewWithString:str];
